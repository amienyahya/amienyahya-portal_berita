    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
              ...
              <form action="{{ url('/admin/post/'.$post->slug) }}" method="POST" class="mb-5"> 
                @method('put')
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select name="category_id" class="form-select "  >
                      ...
                      @if( old('category_id',$post->category_id) == $ctg->id )
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary" name="save">Update Post</button>
                  </div>
                </div>
