                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ url('/admin/category/'.$category->id) }}" method="POST" class="mb-5">
                                        @method('PUT')
                                        @csrf
                                        <div class="row mb-3">
                                            <label for="inputText" class="col-sm-4 col-form-label">Nama Category</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="title" required autofocus value="{{ old('name',$category->name) }}" required>
                                                @error('name')
